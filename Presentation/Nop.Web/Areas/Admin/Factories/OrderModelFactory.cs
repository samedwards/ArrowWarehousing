...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class OrderModelFactory : IOrderModelFactory
    {
        ...
        protected virtual void PrepareOrderModelTotals(OrderModel model, Order order)
        {
            ...
            {
                var addtionalFeeInclTax =
                   Math.Round((order.OrderSubtotalInclTax + order.OrderShippingInclTax) * (order.PaymentMethodAdditionalFeeInclTax / 100), 2);
                var addtionalFeeExclTax =
                    Math.Round((order.OrderSubtotalExclTax + order.OrderShippingExclTax) * (order.PaymentMethodAdditionalFeeExclTax / 100), 2);
                model.PaymentMethodAdditionalFeeInclTax = _priceFormatter.FormatPaymentMethodAdditionalFee(
                    addtionalFeeInclTax, true, primaryStoreCurrency, _workContext.WorkingLanguage, true);
                model.PaymentMethodAdditionalFeeExclTax = _priceFormatter.FormatPaymentMethodAdditionalFee(
                    addtionalFeeExclTax, true, primaryStoreCurrency, _workContext.WorkingLanguage, false);
                //model.PaymentMethodAdditionalFeeInclTax = _priceFormatter.FormatPaymentMethodAdditionalFee(
                ...
                model.PaymentMethodAdditionalFeeInclTaxValue = addtionalFeeInclTax;
                model.PaymentMethodAdditionalFeeExclTaxValue = addtionalFeeExclTax;
            }
            else
            {
